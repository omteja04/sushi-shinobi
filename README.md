<div align="center">
  <br />
      <img src="./assets/sushi-shinobi.jpg" alt="Project Banner">
    </a>
  <br />
  ...
  <h3 align="center">Sushi-Shinobi</h3>
...
Welcome to Sushi Shinobi! This project is a web application that offers a delightful experience of authentic Japanese cuisine, showcasing popular food, trending sushi, and drinks using HTML and CSS with smooth, subtle animations.
...
```bash
git clone https://github.com/omteja04/sushi-shinobi.git
```
...
<html lang="en">
    <head>
        ...
        <!-- cSpell:disable -->
        <title>Sushi Shinobi</title>
    </head>
    <body>
        <header>
            <nav class="header__nav">
                <div class="header__logo">
                    <h4 data-aos="fade-down">Sushi-Shinobi</h4>
        ...
        <section class="hero">
            ...
            <div class="hero-content">
                <div class="hero-content-info" data-aos="fade-left">
                    ...
                    <p>
                        Feel the taste of the most popular Japanese food from
                    ...
                    <div class="hero-content__buttons">
                        ...
                        <button class="hero-content__play-button">
                            <img src="./assets/play-circle.svg" alt="play" />How
                            to Order ?
                        </button>
                    </div>
                </div>
                <div class="hero-content__testimonial" data-aos="fade-up">
                    ...
                    <div class="hero-content__review">
                        ...
                        <p>
                            "This is the best Japanese food delivery service
                            that ever existed.
                        </p>
                    </div>
                </div>
        ...
        <section class="about-us" id="about-us">
            ...
            <div class="about-us__content" data-aos="fade-left">
                ...
                <p class="sushi__description">
                    <!-- cSpell:disable -->
                    We will continue to provide the experience of Omotenashi,
                    the Japanese mindset of hospitality, with our shopping and
        ...
        <section class="popular-foods" id="menu">
            ...
            <div
                class="popular-foods__filters sushi_hide_scrollbar"
                data-aos="fade-up"
            >
                <button class="popular-foods__filters-btn active">All</button>
                <button class="popular-foods__filters-btn">
                    <img src="/assets/sushi-9.png" alt="sushi-9" />Sushi
                </button>
                <button class="popular-foods__filters-btn">
                    <img src="/assets/sushi-8.png" alt="ramen" />Ramen
                </button>
                <button class="popular-foods__filters-btn">
                    <img src="/assets/sushi-7.png" alt="udon" />Udon
                </button>
                <button class="popular-foods__filters-btn">
                    <img src="/assets/sushi-6.png" alt="danggo" />Danggo
                </button>
                <button class="popular-foods__filters-btn">Others</button>
            </div>
            <div class="popular-foods__catalogue" data-aos="fade-up">
                ...
                <article class="popular-foods__card">
                    <img
                        ...
                        class="popular-foods__card-image"
                    />
                    <h4 class="popular-foods__card-title">Amen Legendo</h4>
                    <div class="popular-foods__card-details flex-between">
                        <div class="popular-foods__cards-rating">
                            <img src="assets/star.svg" alt="star" />
                            <p>4.7</p>
        ...
        <section class="trending" id="food">
            ...
            <section class="trending-drinks">
                ...
                <div class="trending__content" data-aos="fade-left">
                    ...
                    <p class="sushi__description">
                        Feel the taste of the most delicious Japense drinks
                        here.
                    </p>
        ...
        <section class="subscription flex-center" id="services">
            ...
            <p data-aos="fade-up">Sign up for the Sushi-Shinobi newsletter</p>
        ...
        <footer class="footer flex-between">
            <h3 class="footer__logo"><span>Sushi</span>-Shinobi</h3>
